...
export type CipherpayAnchor = {
  address: "AWVNBHaF1upXopq9dQpRpY54c9113bBskqiv16MUTDDd";
  metadata: {
  ...
  instructions: [
    {
      ...
      discriminator: [176, 36, 151, 206, 90, 44, 48, 181];
      accounts: [
        {
          name: "rootCache";
          writable: true;
          pda: {
            seeds: [
              {
                kind: "const";
                value: [114, 111, 111, 116, 95, 99, 97, 99, 104, 101];
              },
            ];
          };
        },
    ...
    },
    {
      ...
      discriminator: [61, 37, 70, 72, 104, 99, 240, 39];
      accounts: [
        {
          name: "tree";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [146, 234, 221, 142, 37, 191, 224, 183];
      accounts: [
        {
          name: "payer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [191, 130, 5, 127, 124, 187, 238, 188];
      accounts: [
        {
          name: "payer";
          docs: ["Fee payer / only signer."];
          writable: true;
          signer: true;
        },
        {
          name: "tree";
          docs: ["Global Merkle tree (strict sync with proof’s spent root)."];
          writable: true;
          pda: {
            seeds: [
              {
        ...
        {
          name: "rootCache";
          docs: ["Rolling cache of recent roots (zero-copy account)."];
          writable: true;
          pda: {
            seeds: [
              {
        ...
        },
        {
          ...
          docs: ["Per-nullifier one-shot PDA; prevents double-spends."];
          writable: true;
          pda: {
            seeds: [
              {
    ...
    },
    {
      ...
      discriminator: [212, 34, 45, 239, 90, 192, 208, 2];
      accounts: [
        {
          name: "payer";
          docs: ["Fee payer / only signer."];
        ...
        {
          name: "rootCache";
          docs: ["Rolling Merkle roots cache (PDA, zero-copy)."];
          writable: true;
          pda: {
            seeds: [
              {
        ...
        {
          name: "vaultPda";
          docs: ["Program vault authority PDA (signs CPIs with seeds)."];
          pda: {
            seeds: [
              {
                kind: "const";
        ...
        {
          name: "vaultTokenAccount";
          docs: ["Program vault ATA for the selected mint."];
          writable: true;
          pda: {
            seeds: [
              {
        ...
        {
          name: "recipientOwner";
          docs: ["Recipient’s wallet (ATA authority). **Not a signer**."];
        },
        {
          name: "recipientTokenAccount";
          docs: ["Recipient’s ATA for the same mint."];
          writable: true;
          pda: {
            seeds: [
              {
  ...
  accounts: [
    {
      name: "depositMarker";
      discriminator: [193, 208, 159, 74, 46, 132, 191, 58];
    },
    {
      name: "merkleRootCache";
      discriminator: [126, 183, 252, 198, 190, 104, 88, 26];
    },
    {
      name: "nullifierRecord";
    ...
    {
      name: "treeState";
      discriminator: [251, 163, 240, 50, 165, 217, 193, 100];
    },
  ];
  events: [
    {
      name: "depositCompleted";
      discriminator: [87, 191, 139, 46, 172, 192, 191, 52];
    },
    {
      name: "transferCompleted";
      discriminator: [208, 78, 51, 21, 201, 117, 155, 42];
    },
    {
      name: "withdrawCompleted";
      discriminator: [180, 77, 152, 99, 248, 179, 163, 44];
    },
  ];
  errors: [
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "roots";
            docs: ["Ring buffer of recent roots."];
            type: {
              array: [
                {
                  array: ["u8", 32];
          ...
          {
            name: "nextSlot";
            docs: ["Next write position in the ring (0..MAX_ROOTS-1)."];
            type: "u16";
          },
          {
            name: "count";
            docs: ["Number of valid entries (<= MAX_ROOTS)."];
            type: "u16";
          },
        ];
      };
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Root before appends (from membership proof)"];
            type: {
              array: ["u8", 32];
            };
          },
          {
            name: "newMerkleRoot1";
            docs: ["Root after inserting out1"];
            type: {
              array: ["u8", 32];
            };
          },
          {
            name: "newMerkleRoot2";
            docs: ["Root after inserting out2"];
            type: {
              array: ["u8", 32];
            };
          },
          {
            name: "nextLeafIndex";
            docs: ["Starting leaf index for out1 (out2 uses +1)"];
            type: "u32";
          },
          {
            name: "mint";
            docs: ["SPL mint that identifies the vault this applies to"];
            type: "pubkey";
          },
        ];
      };
